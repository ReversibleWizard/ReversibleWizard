...
### 🤖 AI Portfolio Maker
> *LLM-powered backend that auto-generates personal portfolio sites*

- Prompt-engineered generation pipeline with context-aware LLM calls
- RAG architecture using vector embeddings for personalized content retrieval
- REST API layer with structured output parsing and template rendering

`Python` `Flask` `LLM APIs` `Qdrant` `RAG`
...
### 🎬 [Movie Recommendation System](https://github.com/ReversibleWizard/Movie-Recommender-System)
> *Content-based recommendation engine using feature similarity*

- TF-IDF vectorization and cosine similarity for accurate content matching
- Efficient pandas-based data pipeline processing 5,000+ movie records
- Clean inference interface designed for API integration
...
> *Role-based backend banking application with full CRUD operations*
...
|----------|-------------|---------|
| **LeetCode** | Arrays · HashMaps · Stacks · Queues · Trees · Graphs | [ReversibleWizard](https://leetcode.com/u/ReversibleWizard/) |
...
<p>
  <img src="https://img.shields.io/badge/Become%20an%20LLM%20Engineer%20in%208%20Weeks-Udemy-A435F0?style=flat-square&logo=udemy&logoColor=white" />
  &nbsp;
...
**Open to Backend / AI Engineering roles · Full-time · Internships · Collaborations**
...
*Building systems that think. Architecting backends that scale.*
